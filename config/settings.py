...
PROMPT_MAX_ARG_LEN = _get_env_int("PROMPT_MAX_ARG_LEN", 100000)
...
HARNESS_PROGRESS_POLL_SEC = _get_env_float("HARNESS_PROGRESS_POLL_SEC", 30.0)
HARNESS_STALL_TIMEOUT_SEC = _get_env_float("HARNESS_STALL_TIMEOUT_SEC", 300.0)
HARNESS_STAGE_EXPECTED_DURATION = {
    "plan": _get_env_float("HARNESS_DURATION_PLAN", 120.0),
    "code": _get_env_float("HARNESS_DURATION_CODE", 300.0),
    "review": _get_env_float("HARNESS_DURATION_REVIEW", 180.0),
    "test": _get_env_float("HARNESS_DURATION_TEST", 120.0),
    "e2e_test": _get_env_float("HARNESS_DURATION_E2E_TEST", 300.0),
    "github_ops": _get_env_float("HARNESS_DURATION_GITHUB_OPS", 30.0),
}
