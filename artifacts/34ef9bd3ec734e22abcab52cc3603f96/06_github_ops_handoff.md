...
## Context
- Complexity: complex
- Current Stage: github_ops (github_ops)
...
### test
{"type":"thread.started","thread_id":"019d320a-9b18-7be2-ac5f-c0b60bf88d48"} {"type":"turn.started"} {"type":"item.completed","item":{"id":"item_0","type":"agent_message","text":"当前进入 `test` 阶段。我先检查工作区变更和 `tests/harness` 的现状，然后直接跑验收测试，失败的话就顺着报错补修并把结果整理成交接说明。"}} {"type":"item.s...

### e2e_test
{"type":"thread.started","thread_id":"019d320c-2825-7991-9b37-8594bd9aa9b1"} {"type":"turn.started"} {"type":"item.completed","item":{"id":"item_0","type":"agent_message","text":"我先执行 `e2e_test` 验收路径：检查当前工作区和 `tests/harness` 状态，然后直接跑 `python3 -m pytest tests/harness/ -v`，根据失败结...

## Current Stage Instructions
Execute the `github_ops` stage and leave a concise handoff for the next stage.
